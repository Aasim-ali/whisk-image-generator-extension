...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center pt-20 px-4 relative overflow-hidden">
            ...
            <motion.div
                className="glass-strong p-8 md:p-10 w-full max-w-md relative overflow-hidden border-2 border-white/10"
                initial="hidden"
                animate="visible"
                variants={fadeInUp}
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="text-center mb-8">
                        <motion.div
                            className="w-16 h-16 mx-auto mb-4 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-primary/30"
                        ...
                        <p className="text-gray-400">Sign in to continue to Whisk</p>
                    </div>

                    {/* Error Alert */}
                    {error && (
                        <motion.div
                            className="bg-danger/10 border-2 border-danger/30 text-danger px-4 py-3 rounded-lg mb-6 text-sm backdrop-blur-sm"
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <motion.button
                            type="submit"
                            disabled={loading}
                            className="w-full btn py-3 text-lg font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/40 disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    {/* Google Sign In */}
                    <motion.a
                        href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/oauth/google`}
