            ...
            >
                <Card className="card-base border-none overflow-hidden pb-8">
                    <CardHeader className="text-center pt-10 pb-6">
                        ...
                        <CardTitle className="text-4xl font-black mb-2 text-gray-900">Create Account</CardTitle>
                        <CardDescription className="text-gray-500 font-bold">Join WhiskAutomator to start creating</CardDescription>
                    </CardHeader>
                    ...
                    <CardContent>
                        ...
                        <form onSubmit={handleRegister} className="space-y-6">
                            <div className="space-y-2">
                                <Label className="text-gray-900/70 ml-1">Full Name</Label>
                                <Input
                                    type="text"
                        ...
                        >
                            <a href={`${process.env.NEXT_PUBLIC_API_URL}/oauth/google${isExtension ? '?extension=true' : ''}`}>
                    ...
                    <CardFooter className="flex justify-center pb-0">
                        <p className="text-gray-500 font-bold">
                            ...
                            <Link href="/login" className="text-primary hover:text-primary-dark transition-colors border-b-2 border-primary/20 hover:border-primary">
                                Sign in
                            </Link>
                        </p>
                    </CardFooter>
